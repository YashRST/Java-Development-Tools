...
{
setters.remove(i);
System.out.println("removing the setter from the array of setters: "+setters.get(i).getName()+" |||| "+setterName);
continue;
}
...
Object getterResult;
i=0;
System.out.println("Size of setters/getters array: "+setters.size()+", "+getters.size());
while(i<setters.size())
{
setterMethod=setters.get(i);
...
System.out.println("Result from the getter: "+getterResult);
